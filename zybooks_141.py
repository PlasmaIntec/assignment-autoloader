...
from data import zybook_141_data
...
def upload(url):
	...
	try:
		...
		for assignment in zybook_141_data:
			...
			category_dropdown = crawler.findElementByXPath("//option[text()='zyBooks']")
			...
			grade_short_name_input.send_keys(" ".join(name.split(" ")[1:]))
